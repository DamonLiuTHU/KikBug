...
//    _backGroudView.backgroundColor = [UIColor hexStringToColor:dnSendButtonTintNormalColor];
    self.backGroudView.backgroundColor = THEME_COLOR;
...
//    self.badgeValueLabel.backgroundColor = THEME_COLOR;
    ...
    [_sendButton setTitle:NSLocalizedStringFromTable(@"send", @"DNImagePicker", @"确定")
...
//    [_sendButton setTitleColor:[UIColor hexStringToColor:dnSendButtonTintAbnormalColor] forState:UIControlStateDisabled];
    [self.sendButton setTitleColor:THEME_COLOR forState:UIControlStateNormal];
